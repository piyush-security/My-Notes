- - -
#### "SeBackupPrivilege"
If you've SeBackupPrivilege.
We can use that privilege to read and get any file from the target machine.
If we attack SAM, SYSTEM or ntds.dit some important files we can beacome SYSTEM.
...
> [!note]
> **c:\programdata** is the **writeable path** where you i have **upload dll and creating a test.cab**.
